...
export async function POST(req: Request) {
  try {
    ...
    db().prepare(`INSERT INTO clients
      (id,name,slug,template,brand_primary,brand_accent,logo_text,logo_sub,target_labor_lo,target_labor_hi,notify_email)
      VALUES (?,?,?,?,?,?,?,?,?,?,?)`)
      .run(id, name, slug, template, brandPrimary, brandAccent,
    ...
    audit(s.userId, "CLIENT_CREATE", id);
